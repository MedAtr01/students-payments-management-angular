...
export class AuthenticationService extends BaseService {
   ...
   * This method doesn't expect any request body.
   */
  loadUser$Response(params: LoadUser$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDetails>> {
   ...
   * This method doesn't expect any request body.
   */
  loadUser(params: LoadUser$Params, context?: HttpContext): Observable<UserDetails> {
